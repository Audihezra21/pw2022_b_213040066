...
<nav class="navbar navbar-expand-lg navbar-light  shadow-sm fixed-top">
      ...
      <div class="text-box">
        ...
        <button class="btn fs-5" type="button" > <a href="metaverseadmin.php"> What is Metaverse ? </a></button>
        <button class="btn fs-5" type="button" > <a href="knowmetaverseadmin.php"> System Payment in Metaverse </a></button>
        <button class="btn fs-5" type="button" > <a href="deskripsiadmin.php"> Description of System in Metaverse</a></button>
    </div>
</div>
       <!-- Akhir Jumbotron -->
