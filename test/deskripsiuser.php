...
<html lang="en">
  ...
  <div class="container">
      ...
      <a href="deskripsiuser.php" class="btn btn-primary">Refresh</a>
      <a href="homeuser.php" class="btn btn-primary">Back To Home</a>
      <i class="bi bi-journal-plus"><a href="pdfreportinguser.php" class="btn btn-danger" target="blank">Ingin Cetak PDF?</i></a>
    </button>
        
        <div class="row mt-4 ">
          <div class="col-4">
            <form action="" method="get">
              <div class="a input-group mb-3">
                <input type="text" class="form-control" name="keyword" placeholder="masukan keyword pencarian" autocomplete="off" id="keyword">
                
                <button type="button" class="btn btn-primary me-md-2 btn-padding-x-lg" name="cari" id="tombol-cari">Search</button>                
              </div>
              </div>
            </form>
          </div>
